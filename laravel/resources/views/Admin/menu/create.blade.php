                        ...
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body pb-0 mx-25">
                                    <!-- header section -->
                                    <div class="row mx-0">
                                        <h3 class="invoice-to">افزودن منو جدید </h3>
                                    </div>
                                    <hr>
                                    <!-- logo and title -->
                                    <form action="{{ route('admin.menu.index')}}" method="post">
                                        @csrf
                                    <div class="row my-2 py-50">
                                        <div class="col-sm-6 col-12 order-2 order-sm-1 justify-content-end">
                                            <h6 class="text-info">نام منو</h6>
                                            <input type="text" class="form-control" name="name" placeholder="نام منو">
                                        </div>
                                        <div class="col-sm-6 col-12 order-1 order-sm-1 justify-content-end">
                                            <h6 class="invoice-to">لینک منو</h6>
                                            <input type="text" class="form-control ltr" name="link" placeholder="لینک منو">
                                        </div>
                                        {{-- <div class="col-sm-12 col-12 order-1 order-sm-1 justify-content-end">
                                            <h6 class="invoice-to">مقدار مورد نیاز</h6>
                                            <input type="text" class="form-control ltr" name="value" placeholder="مقدار مورد نیاز">
                                        </div> --}}
                                        <div class="col-sm-12 col-12 order-1 order-sm-1 justify-content-end">
                                            <h6 class="invoice-to">ترتیب منو</h6>
                                            <input type="text" class="form-control" name="tartib" placeholder="ترتیب منو">
                                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between py-50">
                                    ...
                                    <div class="custom-control custom-switch custom-switch-glow">
                                        <input type="checkbox" class="custom-control-input" name="view" id="paymentTerm1">
