                        ...
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body pb-0 mx-25">
                                    ...
                                    <hr>
                                    <!-- logo and title -->
                                    <form role="form" action="{{ route('admin.menuadmin.update',$menuadmin->id)}}" method="POST">
                                        @csrf
                                        @method('PUT');
                                    <div class="row my-2 py-50">
                                        <div class="col-sm-6 col-12 order-2 order-sm-1 justify-content-end">
                                            <h6 class="text-info">نام منو</h6>
                                            <input type="text" class="form-control" name="name" value="{{ old('name', $menuadmin->name) }}" placeholder="نام منو">
                                        </div>
                                        <div class="col-sm-6 col-12 order-1 order-sm-1 justify-content-end">
                                            <h6 class="invoice-to">نام روت</h6>
                                            <input type="text" class="form-control ltr" name="route" value="{{ old('route', $menuadmin->route) }}" placeholder="نام روت">
                                        </div>
                                    </div>
                                    <div class="row my-2 py-50">
                                        <div class="col-sm-6 col-12 order-2 order-sm-1 justify-content-end">
                                            <h6 class="text-info">مسیر منو</h6>
                                            <input type="text" class="form-control ltr" name="link" value="{{ old('link', $menuadmin->link)}}" placeholder="مسیر منو">
                                        </div>
                                        <div class="col-sm-6 col-12 order-1 order-sm-1 justify-content-end">
                                            <h6 class="invoice-to">نام دسترسی</h6>
                                            <input type="text" class="form-control ltr" name="gate"  value="{{ old('gate', $menuadmin->gate)}}" placeholder="نام دسترسی">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row invoice-info">
                                        <div class="col-lg-6 col-md-12 mt-25">
                                            ...
                                            <fieldset class=" form-group">
                                                <input type="text" class="form-control" name="tartib" value="{{ old('tartib', $menuadmin->tartib)}}"  placeholder="ترتیب منو">
                                            </fieldset>
                        ...
                        @endforeach
                                ...
                                <div class="mb-1">
                                    <select class="form-control" name="parent">
                                        ...
                                        <option value="{{ $item->id }}" {{ old('panel') == $item->id || $menuadmin->parent==$item->id  ? 'selected' : '' }}>{{ $item->name}}</option>
                                        @endforeach
                                    </select>
                            </div>
