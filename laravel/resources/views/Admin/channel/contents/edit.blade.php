                        ...
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body pb-0 mx-25">
                                    ...
                                    <!-- logo and title -->
                                    <form role="form"
                                        action="{{ route('admin.channel.content.update',[$channel,$content])}}"
                                        method="POST">
                                        @csrf
                                        @method('PUT')
                                        <div class="row my-2 py-50">
                                            <div class="col-sm-6 col-12 order-2 order-sm-1 justify-content-end">
                                                ...
                                                <input type="text" value="{{old('name',$content->name)}}" name="name"
                                                    class="form-control" placeholder="نام محتوا">
                                            </div>
                                            <div class="col-sm-6 col-12 order-2 order-sm-1 justify-content-end">
                                                ...
                                                <select class="form-control" name="type">
                                                    ...
                                                    <option value="{{ $key }}"
                                                        {{ old('type') == $key || $content->type==$key  ? 'selected' : '' }}>
                                                        {{ $name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <textarea class="form-control rtl" id="editor1" name="content">{{old('content',$content->content)}}</textarea>
                                        </div><!-- /.form-group -->

                                        <div class="col-lg-12 col-md-12 mt-25">
                                            <fieldset class="invoice-address form-group">
                                                <div class="input-group col-sm-12" style="height: 35px">
                                                    <input type="text" class="form-control image_label ltr" value="{{old('file',$content->file)}}" name="file"
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between py-50">
                                    ...
                                    <div class="custom-control custom-switch custom-switch-glow">
                                        <input type="checkbox" class="custom-control-input" name="active"@if ($content->active)
                                        checked=""
                                        @endif
                                            id="paymentTerm">
                                ...
                                <div class="d-flex justify-content-between py-50">
                                    <span class="invoice-terms-title"><i class="bx bx-help-circle text-warning"
                                            data-toggle="popover" data-content="" data-trigger="hover"
                                            data-placement="right"></i>پین کردن محتوا</span>
                                    <div class="custom-control custom-switch custom-switch-glow">
                                        <input type="checkbox" class="custom-control-input" name="pin"@if ($content->pin)
                                        checked=""
                                        @endif
                                            id="paymentTerm2">
