                        ...
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body pb-0 mx-25">
                                    ...
                                    <hr>
                                    <!-- logo and title -->
                                    <form action="{{ route('admin.membertimechannel.update',$membertimechannel->id)}}" method="post">
                                        @csrf
                                        @method('PUT')
                                        <div class="row my-2 py-50">
                                            <div class="col-sm-6 col-12 order-2 order-sm-1 justify-content-end">
                                                ...
                                                <input type="text" class="form-control" name="name"
                                                    placeholder="عنوان حق عضویت کانال" value="{{old('name',$membertimechannel->name)}}">
                                            </div>
                                            ...
                                            <div class="col-sm-6 col-12 order-1 order-sm-1 justify-content-end">
                                                ...
                                                <select class="form-control select2" name="channel_id">
                                                    ...
                                                    <option value="{{ $item->id }}" {{ $membertimechannel->channel_id==$item->id  ? 'selected' : '' }}>{{ $item->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-sm-6 col-12 order-2 order-sm-1 justify-content-end">
                                                <h6 class="text-info">هزینه عضویت (تومان)</h6>
                                                <input type="text" class="form-control"value="{{old('cost',$membertimechannel->cost)}}" name="cost"
                                                    placeholder="">
                                            </div>
                                            <div class="col-sm-6 col-12 order-2 order-sm-1 justify-content-end">
                                                <h6 class="text-info">مدت زمان عضویت(روز)</h6>
                                                <input type="text" class="form-control" value="{{old('days',$membertimechannel->days)}}" name="days"
                                                    placeholder="">
                                            </div>
