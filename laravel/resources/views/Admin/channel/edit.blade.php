                        ...
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body pb-0 mx-25">
                                    <!-- header section -->
                                    <div class="row mx-0">
                                        <h3 class="invoice-to">ویرایش کانال جدید</h3>
                                    </div>
                                    <hr>
                                    <!-- logo and title -->
                                    <form action="{{ route('admin.channel.update',$channel->id)}}" method="post">
                                        ...
                                        <div class="row my-2 py-50">
                                            <div class="col-sm-6 col-12 order-2 order-sm-1 justify-content-end">
                                                <h6 class="text-info">عنوان کانال</h6>
                                                <input type="text" class="form-control" name="name"
                                                    placeholder="عنوان کانال" value="{{old('name',$channel->name)}}">
                                            </div>
                                                ...
                                                <fieldset class="invoice-address form-group">
                                                    <div class="input-group col-sm-12" style="height: 35px">
                                                        <input type="text" id="file_label"
                                                            class="form-control image_label ltr" value="{{old('pic',$channel->pic)}}" name="pic"
                        ...
                        <div class="card invoice-action-wrapper shadow-none border">
                            <div class="card-body">
                                <div class="d-flex justify-content-between py-50">
                                    <span class="invoice-terms-title"><i class="bx bx-help-circle text-warning" data-toggle="popover" data-content="با فعال کردن این گزینه این کانال در اسلایدر وبلاگ نمایش داده می شود" data-trigger="hover" data-placement="right"></i>فعال بودن کانال </span>
                                    <div class="custom-control custom-switch custom-switch-glow">
                                        <input type="checkbox" class="custom-control-input"
                                        @if ($channel->active)
                                        checked=""
                                        @endif name="active" id="paymentTerm1">
                                ...
                                <div class="invoice-action-btn mb-1 d-flex">
                                    ...
                                    <div class="w-50">
                                        <a href="{{route('admin.channel.index')}}" class="btn btn-light-warning btn-block">
