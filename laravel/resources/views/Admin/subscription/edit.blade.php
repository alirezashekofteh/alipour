                        ...
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body pb-0 mx-25">
                                    <!-- header section -->
                                    <div class="row mx-0">
                                        <h3 class="invoice-to">ویرایش حق عضویت</h3>
                                    </div>
                                    <hr>
                                    <!-- logo and title -->
                                    ...
                                    <div class="row my-2 py-50">
                                        <div class="col-sm-6 col-12 order-2 order-sm-1 justify-content-end">
                                            ...
                                            <input type="text" class="form-control" value="{{old('name',$subscription->name)}}" name="name">
                                        </div>
                                        <div class="col-sm-6 col-12 order-1 order-sm-1 justify-content-end">
                                            <h6 class="invoice-to">هزینه حق عضویت</h6>
                                            <input type="text" name="cost" value="{{old('cost',$subscription->cost)}}" class="form-control ltr text-left"
                                                >
                                        </div>
                                        <div class="col-sm-12 col-12 order-1 order-sm-1 justify-content-end">
                                            <h6 class="invoice-to">مدت زمان به روز</h6>
                                            <input type="text" value="{{old('time',$subscription->time)}}" name="time" class="form-control ltr text-left">
                                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between py-50">
                                    ...
                                    <div class="custom-control custom-switch custom-switch-glow">
                                        <input type="checkbox" class="custom-control-input" @if ($subscription->active)
                                        checked=""
