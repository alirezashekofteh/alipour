                        ...
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body pb-0 mx-25">
                                    <!-- header section -->
                                    <div class="row mx-0">
                                        <h3 class="invoice-to">افزودن بازاریاب</h3>
                                    </div>
                                    <hr>
                                    <!-- logo and title -->
                                    <form role="form" action="{{ route('admin.agent.index')}}" method="POST">
                                        @csrf
                                    ...
                                    <div class="row invoice-info">
                                        <div class="col-lg-6 col-md-12 mt-25">
                                            ...
                                            <fieldset class="form-group">
                                                <input type="text" class="form-control" name="rmail"  value="{{old('email')}} " placeholder="ایمیل">
                                            </fieldset>
