                        ...
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body pb-0 mx-25">
                                    <!-- header section -->
                                    <div class="row mx-0">
                                        <h3 class="invoice-to">افزودن سوال به نظر سنجی {{$survey->name}}</h3>
                                    </div>
                                    <hr>
                                    <!-- logo and title -->
                                    <form action="{{ route('admin.survey.question.index',$survey)}}" method="post">
                                        @csrf
                                    <div class="row my-2 py-50">
                                        <div class="col-sm-12 col-12 order-2 order-sm-1 justify-content-end">
                                            <h6 class="text-info">متن سوال</h6>
                                            <input type="text" name="name" class="form-control" placeholder="متن سوال">
                                        </div>
