                        ...
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body pb-0 mx-25">
                                    ...
                                    <hr>
                                    <!-- logo and title -->
                                    <form role="form" action="{{ route('admin.term.video.index',$term)}}" method="POST">
                                        @csrf
                                    <div class="row my-2 py-50">
                                        <div class="col-sm-4 col-12 order-2 order-sm-1 justify-content-end">
                                            <h6 class="text-info">نام ویدئو</h6>
                                            <input type="text" name="title" class="form-control" placeholder="نام ویدئو">
                                        </div>
                                        <div class="col-sm-4 col-12 order-1 order-sm-1 justify-content-end">
                                            <h6 class="invoice-to">قسمت</h6>
                                            <input type="number" name="part" class="form-control ltr text-left"
                                                placeholder="">
                                        </div>
                                        <div class="col-sm-4 col-12 order-1 order-sm-1 justify-content-end">
                                            <h6 class="invoice-to">آی دی کاویمو</h6>
                                            <input type="text" name="kavimo" value="{{old('kavimo')}}" class="form-control ltr text-left">
                                        </div>
                                    </div>
                        ...
                        <div class="card invoice-action-wrapper shadow-none border">
                            <div class="card-body">
                                ...
                                <select class="form-control" name="termcat_id">
                                    ...
                                    <option value="{{ $item->id }}" {{ old('termcat_id') == $item->id  ? 'selected' : '' }}>{{ $item->name}}</option>
                                    @endforeach
                                </select>
                                <div class="d-flex justify-content-between py-50">
                                    ...
                                    <div class="custom-control custom-switch custom-switch-glow">
                                        <input type="checkbox" class="custom-control-input" name="free" id="paymentTerm">
