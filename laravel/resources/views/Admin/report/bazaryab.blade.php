                    ...
                    <div class="col-12">
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb p-0 mb-0">
                                ...
                                <li class="breadcrumb-item active">لیست پرداختی ها توسط لینک های بازاریابی</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                                            ...
                                            <tbody>
                                                @foreach ($orders as $item)
                                                    <tr class="success">
                                                        ...
                                                        <td> <input data-id="{{ $item->id }}" class="toggle-class"
                            ...
                            <div class="card-footer">
                                {{ $orders->appends(['date_start' => request('date_start'), 'date_end' => request('date_end')])->links() }}
                            </div>
                        </div>
                    </div>
                </section>
