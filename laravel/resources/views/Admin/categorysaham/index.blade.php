            ...
            <div class="col-12">
                <div class="card">
                  <div class="card-content">
                    ...
                    <div class="card-body">
                        <a href="{{route('admin.categorysaham.create')}}" class="btn btn-light-info curve mb-2"><i
                      ...
                      <div class="table-responsive">
                        <table class="table table-hover table-striped" id="data-table">
                            ...
                            @foreach($category as $key=>$value)
                                ...
                                <td>
                                    <div class="row">
                                      <a href="{{route('admin.categorysaham.edit',$value->id)}}" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="ویرایش" class="invoice-action-edit cursor-pointer">
                                        <i class="bx bx-edit font-large-1 text-info"></i>
                                      </a>
                                      <form id="delete-form{{$value->id}}" action="{{ route('admin.categorysaham.destroy',$value->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
