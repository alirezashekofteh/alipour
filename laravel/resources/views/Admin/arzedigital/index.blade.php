              ...
              <div class="col-12">
                <div class="breadcrumb-wrapper">
                  <ol class="breadcrumb p-0 mb-0">
                    ...
                    <li class="breadcrumb-item active">لیست ارز های دیجیتال ثبت شده
                    </li>
                  </ol>
                </div>
              </div>
...
<hr>
                    <div class="card-body">
                      ...
                      <a href="{{route('admin.arzedigital.create')}}" class="btn btn-light-info curve mb-2"><i class="bx bxs-add-to-queue"></i>افزودن ارز دیجیتال  جدید </a>
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr class="success">
                            ...
                            <td>
                                <div class="row">
                                <a href="{{route('admin.arzedigital.edit',$item->id)}}"><i class="bx bx-edit font-large-1 text-info" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="ویرایش"></i> </a>
                                <form id="delete-form{{$item->id}}" action="{{ route('admin.arzedigital.destroy' , $item->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                  ...
                  <div class="card-footer">
                    {{ $arzedigital->appends([ 'parent' => request('parent') ])->links() }}
                </div>
                </div>
              </div>
          </section>
