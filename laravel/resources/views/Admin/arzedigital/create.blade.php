                        ...
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body pb-0 mx-25">
                                    ...
                                    <hr>
                                    <!-- logo and title -->
                                    <form action="{{ route('admin.arzedigital.index')}}" method="post">
                                        @csrf
                                    ...
                                    <div class="row my-2 py-50">
                                        <div class="col-sm-6 col-12 order-2 order-sm-1 justify-content-end">
                                            ...
                                            <input type="text" name="name_en" class="form-control ltr" >
                                        </div>
...
تنظیمات نمودار زنده 
                                  ...
                                  <div class="row my-2 py-50">
                                    <div class="col-sm-6 col-12 order-2 order-sm-1 justify-content-end">
                                        ...
                                        <input type="text" name="symbol" class="form-control ltr" >
                                    </div>
                                    <div class="col-sm-6 col-12 order-2 order-sm-1 justify-content-end">
                                        <h6 class="text-info">تم رنگ (light,dark)</h6>
                                        <input type="text" name="theme" class="form-control ltr" >
                                    </div>
                                    <div class="col-sm-6 col-12 order-2 order-sm-1 justify-content-end">
                                        <h6 class="text-info">زبان نمودار (en,fa_IR)</h6>
                                        <input type="text" name="locale" class="form-control ltr" >
                                    </div>
                                    <div class="col-sm-6 col-12 order-2 order-sm-1 justify-content-end">
                                        <h6 class="text-info">اجازه تغییر رمز ارز در نمودار(0,1)</h6>
                                        <input type="text" name="allow_symbol_change" class="form-control ltr" >
                                    </div>
                                    <div class="col-sm-6 col-12 order-2 order-sm-1 justify-content-end">
                                        <h6 class="text-info">مخفی کردن تولبار کناری(0,1)</h6>
                                        <input type="text" name="hide_side_tollbar" class="form-control ltr" >
                                    </div>
                        ...
                        <div class="card invoice-action-wrapper shadow-none border">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between py-50">
                                    <span class="invoice-terms-title"><i class="bx bx-help-circle text-warning" data-toggle="popover" data-content="با فعال سازی این ارز دیجیتال تمام تحلیل های ارز دیجیتال در سایت نمایش داده میشود" data-trigger="hover" data-placement="right"></i> فعال بودن ارز دیجیتال</span>
                                ...
                                <div class="invoice-action-btn mb-1 d-flex">
                                    ...
                                    <div class="w-50">
                                        <a href="{{route('admin.arzedigital.index')}}" class="btn btn-light-warning btn-block">
