                        ...
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body pb-0 mx-25">
                                    ...
                                    <hr>
                                    <!-- logo and title -->
                                    <form enctype="multipart/form-data" action="{{ route('admin.term.termcat.index',$term)}}" rel="form" method="post">
                                        @csrf
                                        <div class="row my-2 py-50">
                                            ...
                                            <div class="col-sm-6 col-12 order-2 order-sm-1 justify-content-end">
                                                ...
                                                <input type="text" class="form-control" name="tartib" placeholder="ترتیب">
                                            </div>
