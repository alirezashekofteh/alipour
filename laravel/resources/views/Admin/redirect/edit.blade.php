                        ...
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body pb-0 mx-25">
                                    ...
                                    <hr>
                                    <!-- logo and title -->
                                    <form action="{{ route('admin.redirecturl.update',$redirecturl->id)}}" method="post">
                                        @csrf
                                        @method('PUT')
                                        <div class="row my-2 py-50">
                                            <div class="col-sm-12 col-12 order-2 order-sm-1 justify-content-end">
                                                <h6 class="text-info">آدرس قدیمی</h6>
                                                <input type="text" class="form-control ltr text-left" name="oldurl"  value="{{old('oldurl',$redirecturl->oldurl)}}"
                                                   >
                                            </div>
                                            <div class="col-sm-12 col-12 order-2 order-sm-1 justify-content-end">
                                                <h6 class="text-info">آدرس جدید</h6>
                                                <input type="text" class="form-control ltr text-left" name="newurl"  value="{{old('newurl',$redirecturl->newurl)}}"
                                                    >
                                            </div>
