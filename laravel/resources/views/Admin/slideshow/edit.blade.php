                                    ...
                                    <form action="{{ route('admin.slideshow.update',$slideshow)}}" method="post">
                                        ...
                                        <div class="row my-2 py-50">
                                            <div class="col-sm-6 col-12 order-2 order-sm-1 justify-content-end">
                                                ...
                                                <input type="text" class="form-control" value="{{old('name',$slideshow->name)}}" name="name"
                                                    placeholder="عنوان اسلایدشو">
                                            </div>
                                            <div class="col-sm-6 col-12 order-2 order-sm-1 justify-content-end">
                                                <h6 class="text-info">لینک مرتبط</h6>
                                                <input type="text" class="form-control text-left ltr" value="{{old('link',$slideshow->link)}}" name="link"
                                                ...
                                                <fieldset class="invoice-address form-group">
                                                    <div class="input-group col-sm-12" style="height: 35px">
                                                        <input type="text" id="file_label"
                                                            class="form-control image_label ltr" value="{{old('pic',$slideshow->pic)}}" name="pic"
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between py-50">
                                    ...
                                    <div class="custom-control custom-switch custom-switch-glow">
                                        <input type="checkbox" class="custom-control-input" @if ($slideshow->active)
                                        checked=""
