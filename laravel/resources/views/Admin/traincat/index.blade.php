            ...
            <div class="col-12">
                <div class="card">
                  <div class="card-content">
                    ...
                    <div class="card-body">
                        <a href="{{route('admin.traincat.create')}}" class="btn btn-light-info curve mb-2"><i
                            class="bx bxs-add-to-queue"></i> افزودن دسته بندی آموزشی جدید </a>
                      ...
                      <div class="table-responsive">
                        <table class="table table-hover table-striped" id="data-table">
                            ...
                            @foreach($traincat as $key=>$value)
                                ...
                                <td>
                                    <div class="row">
                                      <a href="{{route('admin.traincat.edit',$value->id)}}" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="ویرایش" class="invoice-action-edit cursor-pointer">
                                        <i class="bx bx-edit font-large-1 text-info"></i>
                                      </a>
                                      <a href="{{route('admin.tarain.post',$value->id)}}" data-toggle="tooltip" data-placement="bottom" title=""
                                        data-original-title="لیست مطالب"><i
                                            class="bx bx-dialpad font-large-1 text-warning"></i></a>
                                      <form id="delete-form{{$value->id}}" action="{{ route('admin.traincat.destroy',$value->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                  ...
                  <div class="card-footer">
                    {{ $traincat->appends([ 'parent' => request('parent') ])->links() }}
                </div>
                </div>
              </div>
          </section>
