                        ...
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body pb-0 mx-25">
                                    ...
                                    <hr>
                                    <!-- logo and title -->
                                    <form enctype="multipart/form-data" action="{{ route('admin.term.download.update',[$term,$download])}}" rel="form" method="post">
                                        @csrf
                                        @method('PUT')
                                        <div class="row my-2 py-50">
                                            <div class="col-sm-6 col-12 order-2 order-sm-1 justify-content-end">
                                                <h6 class="text-info">نام فایل</h6>
                                                <input type="text" class="form-control" name="name" value="{{old('name',$download->name)}}" placeholder="نام فایل دانلودی">
                                            </div>
                                                ...
                                                <fieldset class="invoice-address form-group">
                                                    <div class="input-group col-sm-12" style="height: 35px">
                                                        <input type="text" id="file_label"
                                                            class="form-control image_label ltr" value="{{old('file',$download->file)}}" name="file"
