                        ...
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body pb-0 mx-25">
                                    ...
                                    <hr>
                                    <!-- logo and title -->
                                    <form action="{{ route('admin.saham.update',$saham)}}" method="post">
                                        @csrf
                                        @method('PUT')
                                    <div class="row my-2 py-50">
                                        <div class="col-sm-6 col-12 order-2 order-sm-1 justify-content-end">
                                            <h6 class="text-info">نام سهم</h6>
                                            <input type="text" name="name" value="{{old('name',$saham->name)}}" class="form-control" placeholder="نام دوره">
                                        </div>
                                        <div class="col-sm-6 col-12 order-2 order-sm-1 justify-content-end">
                                            <h6 class="text-info">آدرس صفحه</h6>
                                            <input type="text" name="slug" value="{{old('slug',$saham->slug)}}" class="form-control" placeholder="نام دوره">
                                        </div>

                                    </div>
                                    <div class="col-sm-12 col-12 order-1 order-sm-1 justify-content-end">
                                        <h6 class="invoice-to">توضیحات سهم</h6>
                                        <textarea  class="form-control rtl" id="editor1" name="content">{{old('content',$saham->content)}}</textarea>
                                    </div>
                                    <hr>
                                        ...
                                        <div class="col-lg-12 col-md-12 mt-25">
                                            <fieldset class="invoice-address form-group">
                                                <div class="input-group col-sm-12" style="height: 35px">
                                                    <input type="text" id="file_label" class="form-control image_label ltr" value="{{old('pic',$saham->pic)}}" name="pic"
                                           ...
                                           <div data-repeater-list="groupa">
                                               ...
                                               <div data-repeater-item>
                                                 <div class="row mb-50">
                                                   ...
                                                   <div class="col-8 invoice-item-title">مقدار</div>
                                                 </div>
                                                 <div class="invoice-item d-flex border rounded mb-1">
                                                     ...
                                                     <div class="col-md-8 col-12 form-group">
                                                        <input type="text" name="value" value="{{$item->value}}" class="form-control" placeholder="مقدار">
                                                      </div>
                    ...
                    <div class="col-xl-3 col-md-4 col-12">
                        <div class="card invoice-action-wrapper shadow-none border">
                            <div class="card-body">
                                ...
                                <select name="category_id" class="form-control rtl text-right">
                                    <option value="">یک مورد را انتخاب کنید</option>
                                    @foreach (\App\Models\Category::where('type','saham')->get() as $item)
                                    <option value="{{ $item->id }}" {{ $saham->category_id==$item->id  ? 'selected' : '' }}>{{ $item->name}}</option>
                                    @endforeach
                                </select>
                                <div class="d-flex justify-content-between py-50">
                                    ...
                                    <div class="custom-control custom-switch custom-switch-glow">
                                        <input type="checkbox" class="custom-control-input" @if ($saham->active)
                                            checked=""
                                ...
                                <textarea name="title" id="" class="form-control">{{old('title',$saham->title)}}</textarea>
                                <h6 class="text-info">توضیحات سئو</h6>
                                <textarea name="description" id="txtmsg" class="form-control">{{old('description',$saham->description)}}</textarea>
