...
<div class="state left">
 ...
 <a id="ng-notification" href="{{route('panel.profile')}}" dideo-checked="true" class="bellanimate">
پروفایل</a>
<a id="" href="{{route('panel.orders')}}" dideo-checked="true" >
  دوره ها
</a>
...
<div class="state right">
  <a id="ng-home" href="{{route('panel.tickets')}}" dideo-checked="true">
    تیکت ها
</a>
 <a id="ng-menu" href="{{route('panel.new.ticket')}}" dideo-checked="true">
    ارسال تیکت
</a>
</div>
 </div>
